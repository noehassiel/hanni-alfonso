<div class="max-w-xl mx-auto px-6 pb-20 anim-fade-up delay-4">
    ...
    <div class="relative"
        ...
        <div class="mx-auto mb-8"
             style="width:60px;height:1px;background:linear-gradient(90deg,transparent,var(--bronze-light),transparent);"></div>
        ...
        <div class="space-y-5">
            <div class="flex items-center gap-4">
                ...
                <h3 class="font-body text-[10px] tracking-[0.3em] uppercase shrink-0" style="color:var(--bronze);">
                    Invitados &mdash; {{ $invitation->max_guests }} {{ $invitation->max_guests > 1 ? 'lugares' : 'lugar' }}
                </h3>
                <div class="grow" style="height:1px;background:var(--parchment);"></div>
            </div>
                    ...
                    <div x-show="$wire.attending == 1" x-transition.opacity.duration.200ms>
                        ...
                        <div x-data="{ guestAtt: {{ (int)($guest['attending'] ?? 1) }} }"
                            ...
                            <label class="flex items-center gap-2.5 cursor-pointer select-none"
                                ...
                                <input type="radio" wire:model="guests.{{ $i }}.attending" value="1"
                                       class="sr-only"
                            ...
                            <label class="flex items-center gap-2.5 cursor-pointer select-none"
                                   style="min-height:44px;-webkit-tap-highlight-color:transparent;">
                                <input type="radio" wire:model="guests.{{ $i }}.attending" value="0"
                                       class="sr-only"
        ...
        <button type="button" wire:click="submit"
                ...
                x-data
                @mouseenter="$el.style.background='var(--charcoal-soft)'"
                @mouseleave="$el.style.background='var(--charcoal)'"
    ...
    <div class="mt-12 text-center">
        <img src="{{ asset('img/wax-seal-botanical.svg') }}"
             class="mx-auto w-10 h-10 opacity-15" alt="" aria-hidden="true">
    </div>
