                    ...
                    <tr>
                        <td
                            ...
                            <p
                                ...
                                Estas cordialmente invitado</p>
                            <h1 style="color: #292524; font-size: 42px; font-weight: 300; margin: 0; line-height: 1.2;">
                                Hanni & Alfonso</h1>
                            <p style="color: #b45309; font-size: 18px; margin: 16px 0 0 0;">24 de Octubre, 2026</p>
                        </td>
                    </tr>
                    {{-- Body --}}
                    <tr>
                        <td style="padding: 30px;">
                            ...
                            <p style="color: #57534e; font-size: 15px; line-height: 1.6; margin: 0 0 16px 0;">
                                Con mucha alegria te invitamos a celebrar nuestra boda. Seria un honor contar con tu
                                presencia en este dia tan especial para nosotros.
                            </p>
                            @if ($invitation->personal_message)
                                <p
                                    style="color: #57534e; font-size: 15px; line-height: 1.6; margin: 0 0 16px 0; font-style: italic; padding: 16px; background-color: #fefce8; border-radius: 8px;">
                                    {{ $invitation->personal_message }}
                                </p>
                            @endif
                            <p style="color: #57534e; font-size: 14px; margin: 0 0 24px 0;">
                                Tienes {{ $invitation->max_guests }}
                                {{ $invitation->max_guests > 1 ? 'lugares reservados' : 'lugar reservado' }}.
                            </p>
                            {{-- CTA Button --}}
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center">
                                        <a href="{{ $invitation->magic_link }}"
                                            style="display: inline-block; background-color: #d97706; color: #ffffff; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-size: 16px; font-weight: 500;">
