...
<body
    style="margin: 0; padding: 0; background-color: #f3f4f6; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
        ...
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td
                            style="background-color: {{ $invitation->status === 'confirmed' ? '#ecfdf5' : '#fef2f2' }}; padding: 20px 30px; text-align: center;">
                            <h2
                                style="color: {{ $invitation->status === 'confirmed' ? '#065f46' : '#991b1b' }}; font-size: 20px; margin: 0;">
                        ...
                        <td style="padding: 30px;">
                            <table width="100%" cellpadding="8" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            style="display: inline-block; padding: 2px 10px; border-radius: 9999px; font-size: 12px; font-weight: 600; {{ $invitation->status === 'confirmed' ? 'background-color: #d1fae5; color: #065f46;' : 'background-color: #fee2e2; color: #991b1b;' }}">
                                        ...
                                        @foreach ($invitation->guests as $guest)
                                            <div style="margin-bottom: 4px;">
                                                ...
                                                @if ($guest->dietary_restrictions)
                                                    <br><small style="color: #6b7280;">Dieta:
                                                        {{ $guest->dietary_restrictions }}</small>
                                                @endif
                                            </div>
                                        @endforeach
                                    </td>
                    ...
                    <tr>
                        <td style="padding: 16px 30px; text-align: center; border-top: 1px solid #e5e7eb;">
                            <p style="color: #9ca3af; font-size: 12px; margin: 0;">Wedding - Notificacion Automatica</p>
                        </td>
                    </tr>
                </table>
            </td>
