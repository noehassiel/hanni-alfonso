                        ...
                        <td style="padding: 30px;">
                            ...
                            @if ($reminderType === 'reminder_1')
                                <p style="color: #57534e; font-size: 15px; line-height: 1.6; margin: 0 0 16px 0;">
                                    Nuestra boda se acerca! Queremos confirmarte que estamos muy emocionados de contar
                                    contigo. Si necesitas actualizar tu confirmacion, puedes hacerlo en el siguiente
                                    enlace.
                                </p>
                            @else
                                <p style="color: #57534e; font-size: 15px; line-height: 1.6; margin: 0 0 16px 0;">
                                    Ya falta muy poco para el gran dia! Te recordamos que nuestra boda sera el 24 de
                                    octubre de 2026. Si necesitas hacer algun cambio en tu confirmacion, aun estas a
                                    tiempo.
                                </p>
                            @endif
